...
launch_sites = np.array(["All Sites"])
launch_sites = np.append(launch_sites, spacex_df["Launch Site"].unique())
...
def scatter(entered_launch_site, entered_payload):
    ...
    if entered_launch_site == "All Sites":
        ...
        new_fig = px.scatter(
            ...
            color="Booster Version Category",
            size="Payload Mass (kg)",
            title="Correlation between Payload an Success for " + entered_launch_site,
        )
